...
{{ Form::open(['action' => ['CompaniesController@update',$companies[0]->id], 'method' => "PATCH", 'files' => true]) }}
<script>
    alert('{{ $companies[0]->id }}');
</script>
    <div class="form-row">
    ...
    {{ Form::submit('Update company',['class'=>'btn btn-primary', 'id'=>'form_submit']) }}
{{ Form::close() }}